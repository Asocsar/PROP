...
public class Cont_CD {
    ...
    private  Object action (String path_o, int id, boolean comprimir, controlador_gestor_fitxer I) throws IOException, controlador_gestor_fitxer.FicheroDescompressionNoValido, controlador_gestor_fitxer.FicheroCompressionNoValido {
        Object L = null;
...
/*
    ...
    public void compressio_descompressio(String path_o, String path_d, int ide, boolean compress) throws controlador_gestor_fitxer.FicheroDescompressionNoValido, controlador_gestor_fitxer.FicheroCompressionNoValido, IOException {
        Object L = null;
        id = ide;
