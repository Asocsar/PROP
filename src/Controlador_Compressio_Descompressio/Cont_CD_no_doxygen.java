        ...
        switch (id) {
            ...
            case "LZ78":
                ...
                if (comprimir) {
                    ...
                    time = L8.get_Time();
                    rate = L8.get_Rate();
                    E.act8(time, rate, b.length/time, comprimir);
                } else {
                    System.out.println("LZ78 descompression ejecutado");
                    L = L8.descompress(b);
                    time = L8.get_Time();
                    E.act8(time, -1, b.length/time, comprimir);
                }
                ...
                case "LZSS":
                    ...
                    if (comprimir) {
                        ...
                        time = LS.getTime();
                        rate = LS.getRate();
                        E.actS(time, rate, b.length/time, comprimir);
                    } else {
                        System.out.println("LZSS descompression ejecutado");
                        L = LS.descompress(b);
                        time = LS.getTime();
                        E.actS(time, -1, b.length/time, comprimir);
                    }
                    break;
                case "LZW":
                    LZW LW = new LZW();
                    if (comprimir) {
                        ...
                        time = LW.getTime();
                        rate = LW.getRate();
                        E.actW(time, rate, b.length/time, comprimir);

                    } else {
                        System.out.println("LZW descompression ejecutado");
                        L = LW.descompress(b);
                        time = LW.getTime();
                        E.actW(time, -1, b.length/time, comprimir);
