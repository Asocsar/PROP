...
public class JPEG {
    ...
    private double rate;
     ...
     /**\brief Creadora
        \pre Cert
        \post Es crea una instància de la classe JPEG
    */
    public JPEG(){
        this.time = 0.0;
        this.rate = 0.0;
    ...
    */
    ...
    /** \brief Transformada del cosinus
        \pre Cert
        \post S'ha aplicat en la matriu la transformada discreta del cosinus
        \details És una subfunció de compress8
    ...
    */
    ...
    /** \brief Transformada inversa del cosinus
        \pre Cert
        \post S'ha aplicat en la matriu la transformada  inversa del cosinus
        \details És una subfunció de decompress8
    */
    ...
    /** \brief Compressió bloc a bloc
        \pre m conté una matriu de 8x8 corresponent a un bloc a la imatge
        \post Retorna un array de ints representant la codificació amb RLE
        \details Aplica la transformació DCT, la quantització i l'encoding fet amb RLE
    */
    ...
    /** \brief Descompressió bloc a bloc
        \pre Cert
        \post Retorna una matriu de mida 8x8 que representa el sub-bloc original
        \details Conversió del int[] a un bloc mitjançant decoding del RLE, desquantització i DCT inversa
    */
    ...
    /** \brief Compressió JPEG
        \pre Cert
        \post Retorna una matriu d'integer que representa el fitxer comprimit
        \details Guardem en 3 canals (Y,Cb,Cr) un array amb # posicions = NBlocs i per cada una guardem el NBlock, de longitud variable segons el grau de compressió del bloc, amb el resultat codificat
    */
    ...
    /** \brief Descompressió JPEG
        \pre Cert
        \post Retorna una matriu d'integer que representa la imatge original
        \details És la decompressió general, reconstrueix la imatge bloc a bloc.
    */
