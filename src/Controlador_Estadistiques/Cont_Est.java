...
public class Cont_Est {
    ...
    //PRE: Cert
    //POST: L'arxiu d'stats ha estat actualitzat amb les estadístiques de l'última compressió
    ...
    public static void Stats_Update() throws  IOException {
        ...
        File out = new File("UpdateEstadisticas.txt");
    ...
    public static void GetStats () throws IOException{ //Set stats from file to classes
        ...
        File OldStats = new File("NuevasEstadisticas.txt");
